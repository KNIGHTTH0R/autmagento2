...
public class CommisionPartyResponse {
	...
	@JsonIgnore
	private String potentialIp;

	public String getPotentialIp() {
		return potentialIp;
	}

	public void setPotentialIp(String potentialIp) {
		this.potentialIp = potentialIp;
	}
