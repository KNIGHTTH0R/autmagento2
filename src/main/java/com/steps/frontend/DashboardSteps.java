...
public class DashboardSteps extends AbstractSteps {
	...
	public void validateDashboardTotalJewerlyBonus(String expectedTotal, String actualTotal) {
		Assert.assertTrue("The dashboard total JB doesn't match - Expected: " + expectedTotal + "   Actual: " + actualTotal.replace(".", "").replace(",", "."),
				expectedTotal.contains(actualTotal.replace(".", "").replace(",", ".")));
	}

	@Step
	public void validateDashboardTotalMarketingBonus(String expectedTotal, String actualTotal) {
		Assert.assertTrue("The dashboard totals MMB doesn't match - Expected: " + expectedTotal + "   Actual: " + actualTotal.replace(".", "").replace(",", "."),
				expectedTotal.contains(actualTotal.replace(".", "").replace(",", ".")));
	}
