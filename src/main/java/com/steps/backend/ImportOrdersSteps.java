...
public class ImportOrdersSteps extends AbstractSteps {
	...
	public void validateOrders(List<DBOrderModel> shopOrderList, List<NavOrderModel> navOrderList) throws Exception {
		...
		for (DBOrderModel order : shopOrderList) {
			...
			System.out.println("compare.getContainsBom()" + compare.getContainsBom());
			...
			validateGrandTotal(order.getGrandTotal(), compare.getCalculatedGrandTotal());
			...
			validateShippingCountryRegionCode(order.getShipCountryId(), compare.getShipToCountryRegionCode());
			validateShippingPostCode(order.getShipToPostcode(), compare.getShipToPostCode());
			validateShippingCity(order.getShipToCity(), compare.getShipToCity());

			validateTaxAmount(order.getTaxAmount(), order.getTaxPrecent(), compare.getCalculatedGrandTotal());
			...
			System.out.println("order.totalip()" + order.getTotalIp());
			System.out.println("compare.totalip()" + compare.getTotalIp());
	...
	@Step
	private void validateTotalIp(String totalIp, String compare) {

		Assert.assertTrue("Failure: Total IP doesn't match: " + totalIp + " - " + compare, compare.contains(totalIp));
	}
	
	@Step
	private void validatePartyId(String partyId, String compare) {
		System.out.println(partyId);
		String shopPartyId = partyId == null ? "0" : "1";

		System.out.println("party id " + shopPartyId);
		Assert.assertTrue("Failure: Is Pom Product doesn't match: " + shopPartyId + " - " + compare,
	...
	private void validateIsPom(String isPom, String compare) {
		...
		Assert.assertTrue("Failure: Is Pom Product doesn't match: " + shopisPom + " - " + compare,
	...
	private void validateIsPreshipped(String isPreshipped, String compare) {
		...
		Assert.assertTrue("Failure: Is Preshipped doesn't match: " + shopIsPreshipped + " - " + compare,
				shopIsPreshipped.contentEquals(compare));
	}

	// private void validateKoboSingleArticle(String koboSingleArticle, String
	// compare) {
	...
	private void validateTaxAmount(String taxAmount, String vatProc, String grandTotal) {
		...
		System.out.println("vat" + vatDouble);
		...
		Assert.assertTrue("Failure: billingCountryRegionCode doesn't match: " + taxAmount + " - " + navTaxAmount,
	...
	private void validateShippingPostCode(String shippingPostCode, String compare) {
		Assert.assertTrue("Failure: billingCountryRegionCode doesn't match: " + shippingPostCode + " - " + compare,
	...
	private void validateShippingCity(String shippingCity, String compare) {
		...
		Assert.assertTrue("Failure: Shipping City doesn't match: " + shippingCity + " - " + compare,
				shippingCity.contentEquals(compare));
	}

	@Step
	private void validateShippingStreet(String shippingStreet, String compare) {
		Assert.assertTrue("Failure: shippingStreet doesn't match: " + shippingStreet + " - " + compare,
	...
	private void validateShippingToCustomerName(String firstname, String lastName, String compare) {
		...
		Assert.assertTrue("Failure: Shipping to Name doesn't match: " + name + " - " + compare, name.contains(compare));
	}
	
	@Step
	private void validateBillingPostCode(String billingPostCode, String compare) {
		Assert.assertTrue("Failure: billingCountryRegionCode doesn't match: " + billingPostCode + " - " + compare,
	...
	private void validateBillingCity(String billingCity, String compare) {
		...
		Assert.assertTrue("Failure: billingCity doesn't match: " + billingCity + " - " + compare,
	...
	private void validateBillingStreet(String billingStreet, String compare) {
		Assert.assertTrue("Failure: BillingStreet doesn't match: " + billingStreet + " - " + compare,
	...
	private void validateBillingToCustomerName(String firstname, String lastName, String compare) {
		...
		Assert.assertTrue("Failure: Billing to Name(last name) doesn't match:" + name + " - " + compare,
	...
	private void validateCustomerName(String firstname, String lastName, String compare) {
		...
		String name = firstname + " " + lastName;
		Assert.assertTrue("Failure: Customer Name doesn't match: " + name + " - " + compare, name.contains(compare));
	}

	@Step
	private void validateStoreLanguage(String storeLanguage, String compare) {
		String comapreStoreLanguage = compare.toLowerCase();
		Assert.assertTrue("Failure: websiteCode doesn't match: " + storeLanguage + " - " + comapreStoreLanguage,
	...
	private void validateWebsiteCode(String websiteCode, String compare) {
		...
		Assert.assertTrue("Failure: websiteCode doesn't match: " + websiteCode + " - " + comapreWebsiteCode,
	...
	private void validateOrderId(String orderId, String compare) {
		Assert.assertTrue("Failure: PaidAt doesn't match: " + orderId + " - " + compare,
	...
	private void validateExternalDocNo(String externalDocNo, String compare) {
		Assert.assertTrue("Failure: ExternalDocNo doesn't match: " + externalDocNo + " - " + compare,
	...
	// private void validateMagentoGrandTotal(String magGrandTotal, String
	// compare) {
	...
	private void validateOrderIncrementId(String incrementId, String compare) {
		Assert.assertTrue("Failure: IncrementId doesn't match: " + incrementId + " - " + compare,
				incrementId.contentEquals(compare));
	}

	// private void validateCalculatedGrandTotal(String magGrandToal, String
	// compare) {
	//
	...
	//
	// Assert.assertTrue("Failure: Grand Total doesn't match: " + magGrandToal +
	// " - " + compare,
	...
	private void validateGrandTotal(String magGrandToal, String compare) {
		...
		// System.out.println(finalMagGrandToal);
		// System.out.println(compare);

		Assert.assertTrue("Failure: Grand Total doesn't match: " + finalMagGrandToal + " - " + compare,
				finalMagGrandToal.contentEquals(compare));
	}
