 ...
 *
 */
public class ConnectWithMeAllocationPage extends AbstractPage {
	...
	public void selectStylistOpt(StyleMode mode, String firstName, String lastName, AddressModel addressModel) {
