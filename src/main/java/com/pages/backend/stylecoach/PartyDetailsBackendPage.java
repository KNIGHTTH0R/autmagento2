...
public class PartyDetailsBackendPage extends AbstractPage {
	...
	public PartyBackendPerformanceModel getPartyBackendPerformance(){
		...
		partyModel.setRetail(getDriver().findElement(By.cssSelector("#performance tr:nth-child(2) td:nth-child(2)")).getText().trim().replace("€", "").replace(",", "."));
		partyModel.setIp(getDriver().findElement(By.cssSelector("#performance tr:nth-child(5) td:nth-child(2)")).getText().trim());
		partyModel.setJewelryBonus(getDriver().findElement(By.cssSelector("#party_hostess_reward tr:nth-child(1) td:nth-child(2)")).getText().trim().replace("€", "").replace(",", "."));
