...
public class MailchimpValidationWorkflows {
	...
	@Title("Verify subscriber data in mailchimp")
	@Step
	...
	public void validateNewContactSubscriberMailchimpProperties(SubscriberModel grabbedModel, SubscriberModel expectedModel) {
		...
		verifyActivatedAt(grabbedModel.getActivatedAt(), expectedModel.getActivatedAt());
		verifyIsStylist(grabbedModel.getIsStylist(), expectedModel.getIsStylist());
		// verifyLastDatePurchase(grabbedModel.getLastPurchase(),
		// expectedModel.getLastPurchase());
		verifyPreferredWebsite(grabbedModel.getPreferredWebsite(), expectedModel.getPreferredWebsite());
		verifyContactOrUser(grabbedModel.getContactOrUser(), expectedModel.getContactOrUser());
		verifyStylistFlag(grabbedModel.getFlagStylist(), expectedModel.getFlagStylist());
		// verifyHostFlag(grabbedModel.getFlagHost(),expectedModel.getFlagHost());
...
//		verifyHostFlag(grabbedModel.getFlagHost(), expectedModel.getFlagHost());
	...
	@Title("Build expected subscriber model based on all gathered informations")
	@Step
	...
	@Title("Build expected subscriber model based on all gathered informations")
	@Step
	public SubscriberModel populateNewCustomerWithKoboFromExistingData(CustomerFormModel dataModel, DateModel dateModel, BasicProductModel basicProductModel,
			ShippingModel shippingModel, String koboCode) {
		SubscriberModel resultSubscriber = new SubscriberModel();
	...
	@Title("Build expected subscriber model based on all gathered informations")
	@Step
	public SubscriberModel populateNewCustomerWithKoboFromExistingDataWithZeroRevenue(CustomerFormModel dataModel, DateModel dateModel, RegularBasicProductModel basicProductModel,
			ShippingModel shippingModel, String koboCode) {
		SubscriberModel resultSubscriber = new SubscriberModel();
	...
	@Title("Build expected subscriber model based on all gathered informations")
	@Step
	public SubscriberModel populatePlaceCustomerOrderSubscriber(CustomerFormModel dataModel, DateModel dateModel, HostBasicProductModel hostbasicProductModel,
			ShippingModel shippingModel, String koboCode) {
		SubscriberModel resultSubscriber = new SubscriberModel();
	...
	@Title("Build expected subscriber model based on all gathered informations")
	@Step
	public SubscriberModel populatePlaceCustomerOrderSubscriberWithZeroRevenues(CustomerFormModel dataModel, DateModel dateModel, HostBasicProductModel hostbasicProductModel,
			ShippingModel shippingModel, String koboCode) {
		SubscriberModel resultSubscriber = new SubscriberModel();
	...
	@Title("Build expected subscriber model based on all gathered informations")
	@Step
	public SubscriberModel populateNewStyleCoachFromExistingDataWithZeroRevenue(CustomerFormModel dataModel, DateModel dateModel, BasicProductModel basicProductModel,
			ShippingModel shippingModel, String subscriptionKoboCode) {
		SubscriberModel resultSubscriber = new SubscriberModel();
	...
	@Title("Build expected subscriber model based on all gathered informations")
	@Step
	public SubscriberModel populateNewStyleCoachFromExistingData(CustomerFormModel dataModel, DateModel dateModel, BasicProductModel basicProductModel,
			ShippingModel shippingModel, String subscriptionKoboCode) {
		SubscriberModel resultSubscriber = new SubscriberModel();
