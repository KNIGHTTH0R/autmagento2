...
@WithTag(name = "US3003", type = "backend")
...
public class US3003ValidateOrderBackOfficeTest extends BaseTest {
	...
	public void setUp() {
		...
		List<OrderModel> orderModelList = MongoReader.getOrderModel("US3003CartSegmentationWithVatBillingShippingDeTest" + Constants.GRAB);
		productsList = MongoReader.grabProductBasicModel("US3003CartSegmentationWithVatBillingShippingDeTest" + Constants.GRAB);
		shippingModelList = MongoReader.grabShippingModel("US3003CartSegmentationWithVatBillingShippingDeTest" + Constants.CALC);
		calcDetailsModelList = MongoReader.grabCalcDetailsModels("US3003CartSegmentationWithVatBillingShippingDeTest" + Constants.CALC);
