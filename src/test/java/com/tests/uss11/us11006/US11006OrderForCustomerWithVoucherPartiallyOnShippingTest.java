...
public class US11006OrderForCustomerWithVoucherPartiallyOnShippingTest extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		try {
			...
			input = new FileInputStream(UrlConstants.RESOURCES_PATH + "uss11" + File.separator + "us11006.properties");
			prop.load(input);
	...
	@Test
	public void us11006OrderForCustomerWithVoucherPartiallyOnShippingTest() {
