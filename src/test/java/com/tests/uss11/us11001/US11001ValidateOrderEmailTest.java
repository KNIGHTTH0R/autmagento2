...
public class US11001ValidateOrderEmailTest extends BaseTest{
	...
	public void setUp() throws Exception {
		...
		orderModel = MongoReader.getOrderModel("US11001PartyHostBuysForCustomerWithVoucherTest" + SoapKeys.GRAB);
