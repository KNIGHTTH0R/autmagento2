...
public class US11001UserProfileOrderIdTest extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		orderModel = MongoReader.grabOrderModels("US11001OrderForCustomerAsPartyHostTest" + SoapKeys.GRAB).get(0);

	}

	@Test
	public void us11001UserProfileOrderIdTest() {
