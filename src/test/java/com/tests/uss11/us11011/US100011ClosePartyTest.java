...
public class US100011ClosePartyTest extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		dateModel = MongoReader.grabDateModels("US10001CreatePartyWithCustomerHostTest" + SoapKeys.GRAB).get(0);
	...
	@Test
	public void us100011ClosePartyTest() {
		if (runTest) {
