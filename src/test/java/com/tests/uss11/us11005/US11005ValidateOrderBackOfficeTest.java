...
public class US11005ValidateOrderBackOfficeTest extends BaseTest {
	...
	public void setUp() {
		...
		List<OrderModel> orderModelList = MongoReader.getOrderModel("US11005PartyHostBuysForCustomerWithVoucherTest" + SoapKeys.GRAB);
		productsList = MongoReader.grabHostBasicProductModel("US11005PartyHostBuysForCustomerWithVoucherTest" + SoapKeys.CALC);
		shippingModelList = MongoReader.grabShippingModel("US11005PartyHostBuysForCustomerWithVoucherTest" + SoapKeys.CALC);
		calcDetailsModelList = MongoReader.grabHostCartCalcDetailsModels("US11005PartyHostBuysForCustomerWithVoucherTest" + SoapKeys.CALC);
	 ...
	 */
	@Test
	public void us11005ValidateOrderBackOfficeTest() {
