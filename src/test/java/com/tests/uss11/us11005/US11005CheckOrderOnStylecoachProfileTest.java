...
public class US11005CheckOrderOnStylecoachProfileTest extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		orderModel = MongoReader.grabOrderModels("US11005PartyHostBuysForCustomerWithVoucherTest" + SoapKeys.GRAB).get(0);

	}

	@Test
	public void us11005CheckOrderOnStylecoachProfileTest() {
