...
public class US16004aNewBorrowWithDefaultTopAndCustomPackageTest extends BaseTest {
	...
	@Test
	public void us16004aNewBorrowWithDefaultTopAndCustomPackageTest() {
		...
		// go to product details page and verify if add to cart is not displayed
		// - >done
