...
public class US16004bNewBorrowWithAllowedTopAndCustomPackageTest extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		productsCartList = MongoReader
				.grabRegularBasicProductModel("US16003RegularCustomerSetProductsInCartAndWishlist" + "CART");
		productsWishList = MongoReader
				.grabRegularBasicProductModel("US16003RegularCustomerSetProductsInCartAndWishlist" + "WISH");
		...
		// customerData =
		// MongoReader.grabCustomerFormModels("US16003RegularCustomerRegistrationTest").get(0);
	...
	public void us16004bNewBorrowWithAllowedTopAndCustomPackageTest() {
		...
		// borrowSystemConfigurationSteps.selectBorrowProcessType("(New process)
		// Allow defined products to be borrowed");
		...
		// !!!! must be changed with Ioana version- verify if borrow appears in
		// my business menu - done
		...
		// //go to product details page and verify if add to cart is not
		// displayed - >done
