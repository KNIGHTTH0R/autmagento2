...
public class US16005CheckPartyWishlistAndBorrowProductTest extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		urlModel = MongoReader.grabUrlModels("US16005CreatePartyWithNewContactHostTest" + SoapKeys.GRAB).get(0);
		productsList = MongoReader.grabRegularBasicProductModel("US16005CustomerAddProductIntoWishlistTest" + SoapKeys.CALC);
		productName = productsList.get(0).getName();

	}

	@Test
	public void us16005CheckPartyWishlistAndBorrowProductTest() {
		...
		partyDetailsSteps.checkIfAddToBorrowCartButtonIsDisplayed(true);
