...
public class US16006ChechEmailAndAcceptInvitationTest extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		try {
			...
			input = new FileInputStream(UrlConstants.RESOURCES_PATH + "uss16" + File.separator + "us16006.properties");
			prop.load(input);
	...
	@Test
	public void us16006ChechEmailAndAcceptInvitationTest() {
