...
public class US16004cPlaceBarrowOrderDeniedTopAndCustomPackageTest extends BaseTest {
	...
	@Test
	public void us16004cPlaceBarrowOrderDeniedTopAndCustomPackageTest() {
		...
		// productData =
		// addBorrowedProductsWorkflow.setXXXBorrowedProductToCart();
		// BorrowCartCalculator.allBorrowedProductsList.add(productData);
		...
		// should delete what i have created for the new functionality !!! <-
		// discussion with Mihai
