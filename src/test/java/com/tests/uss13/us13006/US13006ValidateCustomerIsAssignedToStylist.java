...
public class US13006ValidateCustomerIsAssignedToStylist extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		if (size > 0) {
			...
			stylistPassword = MongoReader.grabCustomerFormModels("US13006HostLeadDykscPlzAndCountryTest").get(0).getPassword();
		} else
	...
	@Test
	public void us13006ValidateCustomerIsAssignedToStylist() {
