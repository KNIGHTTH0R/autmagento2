...
public class US13004ValidateCustomerIsAssignedToStylist extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		if (size > 0) {
			...
			stylistPassword = MongoReader.grabCustomerFormModels("US13004CustomerLeadDykscPlzAndCountryTest").get(0).getPassword();
		} else
			System.out.println("The database has no entries");

		stylistsList = MongoReader.grabDbStylistModels("US13004CustomerLeadDykscPlzAndCountryTest");
	...
	@Test
	public void us13004ValidateCustomerIsAssignedToStylist() {
