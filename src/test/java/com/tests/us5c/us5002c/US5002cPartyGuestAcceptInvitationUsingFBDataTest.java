package com.tests.us5c.us5002c;
...
@WithTag(name = "US5", type = "guest page: accept invitation using FB Data; fbuser:logged in,pippaApp: installed")
@RunWith(SerenityRunner.class)
public class US5002cPartyGuestAcceptInvitationUsingFBDataTest extends BaseTest {
	@Steps
	...
	public void setUp() throws Exception {
		...
		urlModel = MongoReader.grabUrlModels("US5002cCreatePartyWithStylistHostTest" + SoapKeys.GRAB).get(0);
	...
	@Test
	public void us5002cPartyGuestAcceptInvitationUsingFBDataTest() throws Exception {
		facebookLoginSteps.loginToFacebook(email, fbPass);
		...
		onlineStylePartyGuestSteps.clickOnFbRegistrationBtnNoSwitch();
