...
public class US3004ValidateOrderBackOfficeTest extends BaseTest {
	...
	public void setUp() {
		...
		List<OrderModel> orderModelList = MongoReader.getOrderModel("US3004Test" + Constants.GRAB);
		productsList = MongoReader.grabBasicProductModel("US3004Test" + Constants.GRAB);
		shippingModelList = MongoReader.grabShippingModel("US3004Test" + Constants.CALC);
		calcDetailsModelList = MongoReader.grabCalcDetailsModels("US3004Test" + Constants.CALC);
