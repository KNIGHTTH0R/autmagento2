...
@WithTag(name = "US3004", type = "backend")
...
public class US3004ValidateOrderBackOfficeTest extends BaseTest {
	...
	public void setUp() {
		...
		List<OrderModel> orderModelList = MongoReader.getOrderModel("US3004CartSegmentationWithVatAndSmbBillingShippingAtTest" + Constants.GRAB);
		productsList = MongoReader.grabProductBasicModel("US3004CartSegmentationWithVatAndSmbBillingShippingAtTest" + Constants.GRAB);
		shippingModelList = MongoReader.grabShippingModel("US3004CartSegmentationWithVatAndSmbBillingShippingAtTest" + Constants.CALC);
		calcDetailsModelList = MongoReader.grabCalcDetailsModels("US3004CartSegmentationWithVatAndSmbBillingShippingAtTest" + Constants.CALC);
	 ...
	 */
	@Test
	public void us3004ValidateOrderBackOfficeTest() {
