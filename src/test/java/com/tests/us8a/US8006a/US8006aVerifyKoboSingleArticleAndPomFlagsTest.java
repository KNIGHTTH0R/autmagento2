...
public class US8006aVerifyKoboSingleArticleAndPomFlagsTest extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		List<OrderModel> orderModelList = MongoReader.getOrderModel("US8006aCustomerBuyConfigurablePomWithContactBoosterTest" + SoapKeys.GRAB);
