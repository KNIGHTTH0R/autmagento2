package com.tests.us8a.US8006a;
...
public class US8006aCustomerBuyConfigurablePomWithContactBoosterTest extends BaseTest {
...
//			koboCode2 = prop.getProperty("koboCodesimona.popa@evozon.com");
		...
		genProduct2 = MagentoProductsInfoCalls.getProductInfo("2020");
		genProduct2.setIp("34");
	...
	@Test
	public void us8006aCustomerBuyConfigurablePomWithContactBoosterTest() throws Exception {
		...
		productData = addRegularProductsWorkflow.setBasicProductToCart1(genProduct2, "1", "medium");
