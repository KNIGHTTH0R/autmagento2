...
public class US8007aVerifyKoboSingleArticleAndPomFlagsTest extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		List<OrderModel> orderModelList = MongoReader.getOrderModel("US8007aCustomerBuyBundlePomWithContactBoosterTest" + SoapKeys.GRAB);
	...
	@Test
	public void us8007aVerifyKoboSingleArticleAndPomFlagsTest() throws Exception {
