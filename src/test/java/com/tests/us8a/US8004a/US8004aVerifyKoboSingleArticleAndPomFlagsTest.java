package com.tests.us8a.US8004a;
...
public class US8004aVerifyKoboSingleArticleAndPomFlagsTest extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		List<OrderModel> orderModelList = MongoReader.getOrderModel("US8004aCustomerBuySinglePomWithoutKoboVoucherTest" + SoapKeys.GRAB);
	...
	@Test
	public void us8004aVerifyKoboSingleArticleAndPomFlagsTest() throws Exception {
		System.out.println("(model.getKoboSingleArticle() "+model.getKoboSingleArticle());
		System.out.println("model.isPom() "+model.getIsPom());
		regularCartValidationWorkflows.verifyKoboSingleArticle(model.getKoboSingleArticle(), "0");
		regularCartValidationWorkflows.verifyIsPom(model.getKoboSingleArticle(), "0");
