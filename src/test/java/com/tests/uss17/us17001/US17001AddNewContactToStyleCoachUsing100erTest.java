...
public class US17001AddNewContactToStyleCoachUsing100erTest extends BaseTest {
	...
	public void us17001AddNewContactToStyleCoachTest() {
		...
		loungeSteps.gotToContactListPage();
		createNewContactSteps.clickOn100erButton();
		createNewContactSteps.fillCreateNewContactWith100er(dataModel, addressModel,"aut");
		...
		contactValidationWorkflows.validateCreatedContact100erDetails(expectedDetailsModel, grabbedDetailsModel,"aut");
	}
