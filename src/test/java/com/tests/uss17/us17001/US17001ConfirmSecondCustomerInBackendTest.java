...
public class US17001ConfirmSecondCustomerInBackendTest extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		stylistRegistrationData = MongoReader.grabCustomerFormModels("US17001SecondRegularCustomerRegistrationTest").get(0);
	}
