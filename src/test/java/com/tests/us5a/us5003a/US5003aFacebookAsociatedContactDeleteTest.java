...
public class US5003aFacebookAsociatedContactDeleteTest extends BaseTest{
	...
	@Test
	public void us5003aFacebookAsociatedContactDeleteTest() throws SOAPException, IOException{
		backEndSteps.performAdminLogin(Credentials.BE_USER, Credentials.BE_PASS);
		backEndSteps.clickOnContacts();
		
		backEndSteps.searchForContactEmail(fbInviteeUser);
		backEndSteps.selectContact(fbInviteeUser);
