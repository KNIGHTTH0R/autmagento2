...
public class US5004aCustRegistrationFromInvitationTest extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		message = MongoReader.grabStringValue("US5004aInviteFbFriendAppNotInstalledFbLoggedOutTest").get(0);
	...
	@Test
	public void us5004aCustRegistrationFromInvitationTest() throws Exception {
		...
		facebookInvitationSteps.clickOnInvitationLinkAppNotInstalled();
