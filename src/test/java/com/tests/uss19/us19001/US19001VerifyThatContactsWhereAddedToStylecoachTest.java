...
public class US19001VerifyThatContactsWhereAddedToStylecoachTest extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		try {
			...
			prop.load(input);
			stylecoachUsername = prop.getProperty("username");
			stylecoachPassword = prop.getProperty("password");
		...
		contactModel = MongoReader.grabCustomerFormModels("US19001UnregisteredConnectWithMeOnMasterSearchByPlzTest").get(0);

		MongoConnector.cleanCollection(getClass().getSimpleName());
	}

	@Test
	public void us19001VerifyThatContactsWhereAddedToStylecoachTest() {
