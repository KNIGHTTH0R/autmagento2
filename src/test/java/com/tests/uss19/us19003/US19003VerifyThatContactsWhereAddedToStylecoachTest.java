...
public class US19003VerifyThatContactsWhereAddedToStylecoachTest extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		contactModel = MongoReader.grabCustomerFormModels("US19003UnregisteredConnectWithMeOnMasterSearchByNameTest").get(0);
		MongoConnector.cleanCollection(getClass().getSimpleName());
	}

	@Test
	public void us19003VerifyThatContactsWhereAddedToStylecoachTest() {

		customerRegistrationSteps.performLogin(emailUsername, password);
