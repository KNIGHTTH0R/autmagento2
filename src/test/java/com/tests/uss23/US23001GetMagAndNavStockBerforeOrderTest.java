...
public class US23001GetMagAndNavStockBerforeOrderTest extends BaseTest {
	...
	private static List<String> idListToBeDecreased = new ArrayList<String>(Arrays.asList("1292", "1658","2558","4835"));
	private static List<String> skuListToBeDecreased = new ArrayList<String>(Arrays.asList("R065SV-18", "N093SV","N052NL","K091MC"));
