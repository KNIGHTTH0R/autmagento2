package com.tests.uss41.us41001_Borrow.us41001BoosterDataFlow;
...
public class US41001BorrowCheckReceivedEmailsTest extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		try {
			...
			input = new FileInputStream(
					UrlConstants.RESOURCES_PATH + FilePaths.US_41_FOLDER + File.separator + "us41001borrow.properties");
			prop.load(input);
	...
	@Test
	public void us41001BorrowCheckReceivedEmailsTest() {
