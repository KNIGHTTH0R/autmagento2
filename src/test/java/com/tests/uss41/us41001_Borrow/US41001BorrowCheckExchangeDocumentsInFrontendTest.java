...
public class US41001BorrowCheckExchangeDocumentsInFrontendTest extends BaseTest {
	...
	public void setUp() {
		...
		orderModel = MongoReader.grabOrderModels("US41001StyleCoachBorrowsProductsTest" + SoapKeys.GRAB)
				.get(0);
	 ...
	 */
	@Test
	public void us41001BorrowCheckExchangeDocumentsInFrontendTest() {
