...
public class US41001PlaceCustomerCheckOriginalDocumentsInNavTabTest extends BaseTest {
	...
	public void setUp() {
		...
		List<OrderModel> orderModelList = MongoReader.getOrderModel("US41001OrderOnlyZzzProductsForCustomerTest");
	 ...
	 */
	@Test
	public void us41001PlaceCustomerCheckOriginalDocumentsInNavTabTest() {
		...
		ordersSteps.valdateOriginalReturnIsReceived(orderId,false);
		//add here validation
