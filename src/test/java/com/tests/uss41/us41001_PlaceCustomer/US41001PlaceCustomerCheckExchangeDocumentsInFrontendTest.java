...
public class US41001PlaceCustomerCheckExchangeDocumentsInFrontendTest extends BaseTest {
	...
	public void setUp() {
		...
		orderModel = MongoReader.grabOrderModels("US41001OrderOnlyZzzProductsForCustomerTest")
				.get(0);
	 ...
	 */
	@Test
	public void us41001PlaceCustomerCheckExchangeDocumentsInFrontendTest() {
		...
		profileSteps.valdateExchangeReturnIsReceived(false);
