...
public class US41001KoboCheckExchangeDocumentsInFrontendTest extends BaseTest {
	...
	public void setUp() {
		...
		if (size > 0) {
			stylistRegistrationData = MongoReader.grabCustomerFormModels("US41001StyleCoachRegistrationTest").get(0);
		} else
			System.out.println("The database has no entries");

		MongoConnector.cleanCollection(getClass().getSimpleName() + SoapKeys.GRAB);
		MongoConnector.cleanCollection(getClass().getSimpleName() + SoapKeys.CALC);
		orderModel = MongoReader.grabOrderModels("US41001InitialKoboSubscriptionTest" + SoapKeys.GRAB)
				.get(0);
	 ...
	 */
	@Test
	public void us41001KoboCheckExchangeDocumentsInFrontendTest() {
