...
public class US41001KoboNavisionSubscriptionTest extends BaseTest {
	...
	@Test
	public void us41001KoboNavisionSubscriptionTest() throws Exception {
		
		navisionSteps.replicateOrder(orderModel.getOrderId());
		order=navisionSteps.blanketMakeOrder(orderModel.getOrderId());
		navisionSteps.postOrder(order);
