...
public class US41002PayAndImportOrderInNavisionTest extends BaseTest {
	...
	//	orderModel = MongoReader.getOrderModel("US41002CustomerBuyWithForthyDiscountsAndJbTest").get(0);
	}

	@Test
	public void us41002PayAndImportOrderInNavisionTest() throws Exception {
...
//		navisionSteps.performOrderImport(DBorderModel.getOrderId());
		...
		//DBorderModel=OrderInfoMagCalls.getOrderInfo("260865");
		navisionSteps.performOrderImport("260865");
