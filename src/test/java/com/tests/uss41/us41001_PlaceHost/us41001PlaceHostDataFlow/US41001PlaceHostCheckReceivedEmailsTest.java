package com.tests.uss41.us41001_PlaceHost.us41001PlaceHostDataFlow;
...
public class US41001PlaceHostCheckReceivedEmailsTest extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		orderModel = MongoReader.getOrderModel("US41001PlaceHostOrderWithForthyDiscountsAndJbTest"+SoapKeys.GRAB).get(0);
		...
		try {
			...
			input = new FileInputStream(
					UrlConstants.RESOURCES_PATH + FilePaths.US_41_FOLDER + File.separator + "us41001host.properties");
			prop.load(input);
	...
	@Test
	public void us41001PlaceHostCheckReceivedEmailsTest() {
