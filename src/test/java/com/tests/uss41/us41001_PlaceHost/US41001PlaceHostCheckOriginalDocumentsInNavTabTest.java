...
public class US41001PlaceHostCheckOriginalDocumentsInNavTabTest extends BaseTest {
	...
	public void setUp() {
		...
		List<OrderModel> orderModelList = MongoReader.getOrderModel("US41001PlaceHostOrderWithForthyDiscountsAndJbTest" + SoapKeys.GRAB);
	 ...
	 */
	@Test
	public void us41001PlaceHostCheckOriginalDocumentsInNavTabTest() {
