...
public class US41001PlaceHostCheckOriginalDocumentsInFrontendTest extends BaseTest {
	...
	public void setUp() {
		...
		orderModel = MongoReader.grabOrderModels("US41001PlaceHostOrderWithForthyDiscountsAndJbTest" + SoapKeys.GRAB)
				.get(0);
	 ...
	 */
	@Test
	public void us41001PlaceHostCheckOriginalDocumentsInFrontendTest() {
		...
		profileSteps.sendOriginalDocumentsToCustomer("invoice");
