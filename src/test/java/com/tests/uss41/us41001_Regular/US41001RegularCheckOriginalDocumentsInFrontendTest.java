...
public class US41001RegularCheckOriginalDocumentsInFrontendTest extends BaseTest {
	...
	public void setUp() {
		...
		try {
			input = new FileInputStream(UrlConstants.RESOURCES_PATH + "uss41" + File.separator + "us41001.properties");
			prop.load(input);
		...
		orderModel = MongoReader.grabOrderModels("US41001CustomerBuyWithForthyDiscountsAndJbTest" + SoapKeys.GRAB)
				.get(0);
	 ...
	 */
	@Test
	public void us41001RegularCheckOriginalDocumentsInFrontendTest() {
		...
		profileSteps.valdateOriginalReturnIsReceived(true);
