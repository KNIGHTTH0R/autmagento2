...
public class US41001SFMCheckExchangeDocumentsInNavTabTest extends BaseTest {
	...
	public void setUp() {
		...
		List<OrderModel> orderModelList = MongoReader.getOrderModel("US41001ShopForMyselfOrderTest" + SoapKeys.GRAB);
	 ...
	 */
	@Test
	public void us41001SFMCheckExchangeDocumentsInNavTabTest() {
