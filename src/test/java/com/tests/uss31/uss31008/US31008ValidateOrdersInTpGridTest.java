...
public class US31008ValidateOrdersInTpGridTest extends BaseTest {
	...
	private static List<BasicProductModel> productsListTp3 = new ArrayList<BasicProductModel>();
	...
	private static List<BasicProductModel> productsListTp4 = new ArrayList<BasicProductModel>();
	...
	private static List<BasicProductModel> productsListTp5 = new ArrayList<BasicProductModel>();
...
//	OrderModel orderModelListTp6 = new OrderModel();
	...
	public void setUp() {
		...
		detailedProdListTp3 = MongoReader.grabProductDetailedModel("US31008SfmWithTpTestSemiAutomatedCronTest" + "TP3")
				.get(0);
		productsListTp3 = MongoReader.grabBasicProductModel("US31008SfmWithTpTestSemiAutomatedCronTest" + "TP3");

		orderModelListTp4 = MongoReader.getOrderModel("US31008SfmWithTpTestSemiAutomatedCronTest" + "TP4").get(0);
		detailedProdListTp4 = MongoReader.grabProductDetailedModel("US31008SfmWithTpTestSemiAutomatedCronTest" + "TP4")
				.get(0);
		productsListTp4 = MongoReader.grabBasicProductModel("US31008SfmWithTpTestSemiAutomatedCronTest" + "TP4");

		orderModelListTp5 = MongoReader.getOrderModel("US31008SfmWithTpTestSemiAutomatedCronTest" + "TP5").get(0);
		detailedProdListTp5 = MongoReader.grabProductDetailedModel("US31008SfmWithTpTestSemiAutomatedCronTest" + "TP5")
				.get(0);
		productsListTp5 = MongoReader.grabBasicProductModel("US31008SfmWithTpTestSemiAutomatedCronTest" + "TP5");
		prod5IncrementId = MongoReader.grabIncrementId("US31008SfmWithTpTestSemiAutomatedCronTest" + "TP5");
...
//				productsListTp6.get(0).getQuantity()));
	...
	// @Pending
	@Test
	public void us31008ValidateOrdersInTpGridTest() throws ParseException {
