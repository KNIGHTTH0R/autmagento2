...
public class US31008ValidateReleaseEmailForStylist1Test extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		termPurchaseModel = MongoReader.grabTermPurchaseOrderModel("US31008ValidateCanceledAndReleasedOrdersInTpGridTest" + "TP2").get(0);
