...
public class US31008ValidatePostponedOrdersInTpGridTest extends BaseTest {
	...
	public void setUp() throws ParseException {
		...
		prod1IncrementId = MongoReader.grabIncrementId("US31008SfmWithTpTestSemiAutomatedCronTest" + "TP1");

		orderModelListTp2 = MongoReader.getOrderModel("US31008SfmWithTpTestSemiAutomatedCronTest" + "TP2").get(0);
		prod2IncrementId = MongoReader.grabIncrementId("US31008SfmWithTpTestSemiAutomatedCronTest" + "TP2");
	...
	@Test
	public void us31008ValidatePostponedOrdersInTpGridTest() throws ParseException {
