...
public class US31007ValidatePostponedOrdersInTpGridTest extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		orderModelListTp1 = MongoReader.getOrderModel("US31007SfmWithTpTestAutomatedOnlyReleaseCronTest" + "TP1").get(0);
		detailedProdListTp1 = MongoReader.grabProductDetailedModel("US31007SfmWithTpTestAutomatedOnlyReleaseCronTest" + "TP1").get(0);
		productsListTp1 = MongoReader.grabBasicProductModel("US31007SfmWithTpTestAutomatedOnlyReleaseCronTest" + "TP1");
		System.out.println("order id "+orderModelListTp1.getOrderId() );
		System.out.println("productsListTp1.get(0).getProdCode()");
		...
		prod2IncrementId = MongoReader.grabIncrementId("US31007SfmWithTpTestAutomatedOnlyReleaseCronTest" + "TP2");
		orderModelListTp2 = MongoReader.getOrderModel("US31007SfmWithTpTestAutomatedOnlyReleaseCronTest" + "TP2").get(0);

		prod3IncrementId = MongoReader.grabIncrementId("US31007SfmWithTpTestAutomatedOnlyReleaseCronTest" + "TP3");
		orderModelListTp3 = MongoReader.getOrderModel("US31007SfmWithTpTestAutomatedOnlyReleaseCronTest" + "TP3").get(0);

		expectedModel1 = new TermPurchaseOrderModel();
		expectedModel1.setIncrementId(orderModelListTp1.getOrderId());

		String executionDate = DateUtils.getCurrentDate("yyyy-MM-dd");

		expectedModel1.setExecutionDate(executionDate);
	...
	@Test
	public void us31007ValidatePostponedOrdersInTpGridTest() throws ParseException {
