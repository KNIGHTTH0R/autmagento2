...
public class US31001ValidatePostponeEmail3ForCustomerTest extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		termPurchaseModel = MongoReader.grabTermPurchaseOrderModel("US31001ValidatePostponedOrdersInTpGrid3Test"+ "TP6").get(0);
	...
	@Test
	public void us31001ValidatePostponeEmail3ForCustomerTest() throws ParseException {
	
		frontEndSteps.performLogin(email, password);

		String message = gmailConnector.searchForMail("", "Bestellung verschieben", false);
