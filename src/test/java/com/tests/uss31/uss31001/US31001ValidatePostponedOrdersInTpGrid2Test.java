...
public class US31001ValidatePostponedOrdersInTpGrid2Test extends BaseTest {
	...
	public void setUp() throws ParseException {
		...
		detailedProdListTp = MongoReader.grabProductDetailedModel("US31001PartyHostBuysForCustomerTpTest" + "TP5")
				.get(0);
		...
		detailedProdListTp.getStockData().setEarliestAvailability(
	...
	public void runCron() throws Exception {
		...
		// + orderModelListTp2.getOrderId() + EnvironmentConstants.JOB_TOKEN);
