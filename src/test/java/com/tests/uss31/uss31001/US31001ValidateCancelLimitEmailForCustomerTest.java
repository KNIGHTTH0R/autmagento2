...
public class US31001ValidateCancelLimitEmailForCustomerTest extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		termPurchaseModel = MongoReader.grabTermPurchaseOrderModel("US31001ValidateCancelLimitReachedOrdersInTpGridTest" + "TP6").get(0);
	...
	@Test
	public void us31001ValidateCancelLimitEmailForCustomerTest() throws ParseException {
	
		frontEndSteps.performLogin(email, password);

		String message = gmailConnector.searchForMail("", "Bestellung stornieren", true);
		System.out.println(message);
		emailSteps.validateEmailContent("aufgrund einer Terminverschiebung storniert.", message);
