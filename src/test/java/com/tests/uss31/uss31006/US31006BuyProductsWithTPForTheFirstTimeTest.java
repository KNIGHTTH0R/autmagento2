...
public class US31006BuyProductsWithTPForTheFirstTimeTest extends BaseTest {
...
//		incrementId=MagentoProductCalls.createApiProduct(genProduct1);
		...
		genProduct1.setIp("25");
		genProduct1.setStockData(MagentoProductCalls.createNotAvailableYetStockData(DateUtils.getNextMonthMiddle("yyyy-MM-dd")));
		incrementId = MagentoProductCalls.createApiProduct(genProduct1);
	...
	@Test
	public void us31006BuyProductsForTheFirstTimeTest() {
