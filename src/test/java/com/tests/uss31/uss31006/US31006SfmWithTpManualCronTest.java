...
public class US31006SfmWithTpManualCronTest extends BaseTest {
	...
	public void setUp() throws ParseException {
		...
		productsList = MongoReader.grabBasicProductModel("US31006BuyProductsWithTPForTheFirstTimeTest" + SoapKeys.GRAB);
		...
		genProduct2.setIp(productsList.get(0).getPriceIP());
		genProduct2.setStockData(MagentoProductCalls.createNotAvailableYetStockData(DateUtils.getNextMonthMiddle("yyyy-MM-dd")));
		prod2IncrementId = MongoReader.grabIncrementId("US31006BuyProductsWithTPForTheFirstTimeTest");
	...
	@Test
	public void us31006SfmWithTpManualCronTest() throws ParseException {
		...
		System.out.println("deliveryTP4" +deliveryTP4);
		...
		productData = addProductsWorkflow.setBasicProductToCart(genProduct4, "1", "0", ConfigConstants.DISCOUNT_25);
		if (!genProduct4.getStockData().getEarliestAvailability().contentEquals(""))
			productData.setDeliveryDate(deliveryTP4);
		CartCalculator.productsList25.add(productData);
...
//		cartSteps.selectDeliveryDate(genProduct3.getSku(), deliveryTP3Locale, "table-marketing-material");
	...
	public void saveData() throws Exception {
		...
		MongoWriter.saveIncrementId(prod4IncrementId, getClass().getSimpleName() + "TP3");
