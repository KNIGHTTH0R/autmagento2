...
public class US31006ValidateCanceledAndReleasedByAdminOrdersInTpGridTest extends BaseTest {
	...
	public void setUp() throws ParseException {
		...
		detailedProdListTp2 = MongoReader.grabProductDetailedModel("US31006SfmWithTpManualCronTest" + "TP2")
				.get(0);
		detailedProdListTp2.getStockData().setIsDiscontinued("1");
		detailedProdListTp2.getStockData().setQty("1000");
		productsListTp2 = MongoReader.grabBasicProductModel("US31006SfmWithTpManualCronTest" + "TP2");

		orderModelListTp3 = MongoReader.getOrderModel("US31006SfmWithTpManualCronTest" + "TP3").get(0);
		orderModelListTp4 = MongoReader.getOrderModel("US31006SfmWithTpManualCronTest" + "TP4").get(0);
	...
	@Test
	public void us31006ValidateCanceledAndReleasedByAdminOrdersInTpGridTest() throws ParseException {
