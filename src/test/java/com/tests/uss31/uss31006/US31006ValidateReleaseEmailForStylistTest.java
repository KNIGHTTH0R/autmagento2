...
public class US31006ValidateReleaseEmailForStylistTest extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		termPurchaseModel = MongoReader.grabTermPurchaseOrderModel("US31006ValidateCanceledAndReleasedByAdminOrdersInTpGridTest"+"TP2").get(0);

		System.out.println("termPurchaseModel" +termPurchaseModel);
	...
	@Test
	public void us31006ValidateReleaseEmailForStylistTest() throws ParseException {
