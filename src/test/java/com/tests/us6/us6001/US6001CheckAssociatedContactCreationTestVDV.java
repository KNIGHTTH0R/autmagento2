...
public class US6001CheckAssociatedContactCreationTestVDV extends BaseTest {
	...
	private String prefferedStylist = "Pippa Jean (1)";

	@Before
	public void setUp() throws Exception {

		customerFormModel = MongoReader.grabCustomerFormModels("US6001ScRegistrationNewCustomerTestVDV").get(0);
		addressModel = MongoReader.grabAddressModels("US6001ScRegistrationNewCustomerTestVDV").get(0);
		dateModel = MongoReader.grabDateModels("US6001ScRegistrationNewCustomerTestVDV").get(0);
	...
	@Test
	public void us6001CheckAssociatedContactCreationTestVDV() {
