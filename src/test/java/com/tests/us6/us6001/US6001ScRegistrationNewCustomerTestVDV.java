...
public class US6001ScRegistrationNewCustomerTestVDV extends BaseTest {
	...
	@Test
	public void us6001ScRegistrationNewCustomerTestVDV() {

		headerSteps.navigateToSCRegisterForm();
