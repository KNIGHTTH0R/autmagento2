...
public class US6001CheckStylistActivationTestVDV extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		formCreationDate = MongoReader.grabDateModels("US6001ScRegistrationNewCustomerTestVDV").get(0).getDate();
		int size = MongoReader.grabCustomerFormModels("US6001ScRegistrationNewCustomerTestVDV").size();
		if (size > 0) {
			stylistRegistrationData = MongoReader.grabCustomerFormModels("US6001ScRegistrationNewCustomerTestVDV").get(0);
		} else
	...
	@Test
	public void us6001CheckStylistActivationTestVDV() {
	...
	/*	customerAndStylistRegistrationWorkflows.setValidateStylistProperties(grabAfterLinkConfirmationStylistData,
				expectedAfterLinkConfirmationStylistData);
		customerAndStylistRegistrationWorkflows.validateStylistProperties("AFTER CONFIRMATION LINK");*/

		customerAndStylistRegistrationWorkflows.setValidateStylistProperties(grabOrderPaidStylistData,
				expectedOrderPaidStylistData);
