...
public class US6001ValidateStarterSetOrderInBackendTestVDV extends BaseTest {
	...
	public void setUp() {
		...
		List<OrderModel> orderModelList = MongoReader.getOrderModel("US6001ScRegistrationNewCustomerTestVDV");
		shippingModelList = MongoReader.grabShippingModel("US6001ScRegistrationNewCustomerTestVDV");
		calcDetailsModelList = MongoReader.grabStarterSetCartCalcDetailsModels("US6001ScRegistrationNewCustomerTestVDV");
	...
	@Test
	public void us6001ValidateStarterSetOrderInBackendTestVDV() {
