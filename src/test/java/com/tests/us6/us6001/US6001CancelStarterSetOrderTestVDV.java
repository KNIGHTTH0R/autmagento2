...
public class US6001CancelStarterSetOrderTestVDV extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		orderModel = MongoReader.grabOrderModels("US6001ScRegistrationNewCustomerTestVDV").get(0);
		System.out.println(orderModel.getOrderId());
	}

	@Test
	public void us6001CancelStarterSetOrderTestVDV() throws Exception {
