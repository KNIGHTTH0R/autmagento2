...
public class US9002ValidateOrderBackOfficeTest extends BaseTest {
	...
	public void setUp() {
		...
		List<OrderModel> orderModelList = MongoReader.getOrderModel("US9002PartyHostBuyWithForthyDiscountsJbAndBuy3Get1Test" + Constants.GRAB);
		productsList = MongoReader.grabHostBasicProductModel("US9002PartyHostBuyWithForthyDiscountsJbAndBuy3Get1Test" + Constants.CALC);
		shippingModelList = MongoReader.grabShippingModel("US9002PartyHostBuyWithForthyDiscountsJbAndBuy3Get1Test" + Constants.CALC);
		calcDetailsModelList = MongoReader.grabHostCartCalcDetailsModels("US9002PartyHostBuyWithForthyDiscountsJbAndBuy3Get1Test" + Constants.CALC);
