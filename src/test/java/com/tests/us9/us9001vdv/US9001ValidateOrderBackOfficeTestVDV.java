package com.tests.us9.us9001vdv;
...
public class US9001ValidateOrderBackOfficeTestVDV extends BaseTest {
	...
	public void setUp() {
		...
		List<OrderModel> orderModelList = MongoReader.getOrderModel("US9001PlaceHostOrderWithNoBonnusTestVDV" + SoapKeys.GRAB);
		productsList = MongoReader.grabHostBasicProductModel("US9001PlaceHostOrderWithNoBonnusTestVDV" + SoapKeys.CALC);
		shippingModelList = MongoReader.grabShippingModel("US9001PlaceHostOrderWithNoBonnusTestVDV" + SoapKeys.CALC);
		calcDetailsModelList = MongoReader.grabHostCartCalcDetailsModels("US9001PlaceHostOrderWithNoBonnusTestVDV" + SoapKeys.CALC);
	 ...
	 */
	@Test
	public void us9001ValidateOrderBackOfficeTestVDV() {
