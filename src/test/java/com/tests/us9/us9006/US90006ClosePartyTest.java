...
public class US90006ClosePartyTest extends BaseTest {
	@Steps
	...
	public void setUp() throws Exception {
		...
		urlModel = MongoReader.grabUrlModels("US9006CreatePartyWithStylistHostTest" +SoapKeys.GRAB).get(0);

	}

	@Test
	public void us90006ClosePartyTest() {
