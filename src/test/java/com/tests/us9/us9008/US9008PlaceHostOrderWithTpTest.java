...
public class US9008PlaceHostOrderWithTpTest extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		System.out.println("p1 "+genProduct1.getSku());
		genProduct2 = createdProductsList.get(8);
		System.out.println("p2 "+genProduct2.getSku());
		genProduct3 = createdProductsList.get(11);
		System.out.println("p3 "+genProduct3.getSku());
		genProduct4 = createdProductsList.get(12);
		System.out.println("p4 "+genProduct4.getSku());
		...
		// partyUrlModel =
		// MongoReader.grabUrlModels("US10001bCreatePartyWithStylistHostTest" +
		// SoapKeys.GRAB).get(0);
		partyUrlModel = MongoReader.grabUrlModels("US10008CreatePartyWithExistingContactHostTest").get(0);
		System.out.println(partyUrlModel);
	}

	@Test
	public void us9008PlaceHostOrderWithTpTest() throws ParseException {
	...
	//	shippingSteps.setSameAsBilling(true);
		shippingSteps.checkIsPreshippedFlag();
