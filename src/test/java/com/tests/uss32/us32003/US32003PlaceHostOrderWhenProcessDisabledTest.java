...
public class US32003PlaceHostOrderWhenProcessDisabledTest extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		partyUrlModel = MongoReader.grabUrlModels("US32003CreatePartyWithStylistHostTest" + SoapKeys.GRAB).get(0);
		System.out.println("partyUrlModel " + partyUrlModel.getUrl());
	}

	@Test
	public void us32003PlaceHostOrderWhenProcessDisabledTest() throws ParseException {
