...
@WithTag(name = "US3005", type = "backend")
...
public class US3005ValidateOrderBackOfficeTest extends BaseTest {
	...
	public void setUp() {
		...
		List<OrderModel> orderModelList = MongoReader.getOrderModel("US3005CartSegmentationWithVatAndSmbBillingDeShippingAtTest" + Constants.GRAB);
		productsList = MongoReader.grabProductBasicModel("US3005CartSegmentationWithVatAndSmbBillingDeShippingAtTest" + Constants.GRAB);
		shippingModelList = MongoReader.grabShippingModel("US3005CartSegmentationWithVatAndSmbBillingDeShippingAtTest" + Constants.CALC);
		calcDetailsModelList = MongoReader.grabCalcDetailsModels("US3005CartSegmentationWithVatAndSmbBillingDeShippingAtTest" + Constants.CALC);
	 ...
	 */
	@Test
	public void us3005ValidateOrderBackOfficeTest() {
