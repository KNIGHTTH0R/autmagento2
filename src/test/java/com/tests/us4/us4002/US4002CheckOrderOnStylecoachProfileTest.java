...
public class US4002CheckOrderOnStylecoachProfileTest extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		orderModel = MongoReader.grabOrderModels("US4002ShopForMyselfWithBuy3GetOneTest" + SoapKeys.GRAB).get(0);

	}

	@Test
	public void us4002CheckOrderOnStylecoachProfileTest() {
