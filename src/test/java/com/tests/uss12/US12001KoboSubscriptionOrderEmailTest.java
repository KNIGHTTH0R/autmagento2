...
public class US12001KoboSubscriptionOrderEmailTest extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		stylistEmail = MongoReader.grabCustomerFormModels("US12001KoboSubscriptionTest").get(0).getEmailName();
		orderModel = MongoReader.grabOrderModels("US12001KoboSubscriptionTest").get(0);
