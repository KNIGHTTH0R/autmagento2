...
public class US7004CheckCustomerActivationTestVDV extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		if (size > 0) {
			clientName = MongoReader.grabCustomerFormModels("US7004RegularCustDykscSearchByNameTestVDV").get(0).getEmailName();
	...
	@Test
	public void us7004CheckCustomerActivationTestVDV() {
