...
public class US7005ValidateCustomerIsAssignedToStylistVDV extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		int size = MongoReader.grabCustomerFormModels("US7005RegCustRegUnderSpecificBEStylistTestVDV").size();
		if (size > 0) {
			stylistEmail = MongoReader.grabCustomerFormModels("US7005RegCustRegUnderSpecificBEStylistTestVDV").get(0).getEmailName();
			stylistPassword = MongoReader.grabCustomerFormModels("US7005RegCustRegUnderSpecificBEStylistTestVDV").get(0).getPassword();
	...
	@Test
	public void us7005ValidateCustomerIsAssignedToStylistVDV() {
