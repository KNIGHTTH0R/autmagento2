...
public class US7005CheckCustomerActivationTestVDV extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		if (size > 0) {
			clientName = MongoReader.grabCustomerFormModels("US7005RegCustRegUnderSpecificBEStylistTestVDV").get(0).getEmailName();
	...
	@Test
	public void us7005CheckCustomerActivationTestVDV() {
