package com.tests.us7.uss70016;
...
public class US70016RegisteredConnectWithMeOnContextTest extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		try {
			...
			input = new FileInputStream(UrlConstants.RESOURCES_PATH + "us7" + File.separator + "us70016.properties");
			prop.load(input);
