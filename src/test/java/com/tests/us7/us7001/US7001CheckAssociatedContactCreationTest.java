...
public class US7001CheckAssociatedContactCreationTest extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		customerFormModel = MongoReader.grabCustomerFormModels("US7001RegularCustRegOnMasterTest").get(0);
		addressModel = MongoReader.grabAddressModels("US7001RegularCustRegOnMasterTest").get(0);
	...
	@Test
	public void us7001CheckAssociatedContactCreationTest() {
