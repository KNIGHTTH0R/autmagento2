...
public class US70014KoboCampaignRegistrationWithContactDetailsTest extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		try {
			...
			input = new FileInputStream(UrlConstants.RESOURCES_PATH + "us7" + File.separator + "us70013.properties");
			prop.load(input);
		...
		CustomerFormModel expectedCustomerData = MongoReader
				.grabCustomerFormModels("US70014CreateContactUnderQualifiedScTest").get(0);
		AddressModel expectedCustomerAddress = MongoReader.grabAddressModels("US70014CreateContactUnderQualifiedScTest")
				.get(0);
		...
		dataModel.setFirstName(expectedCustomerData.getFirstName());
		dataModel.setLastName(expectedCustomerData.getLastName());

		addressModel = new AddressModel();
		addressModel.setPostCode(postalCode);
		addressModel.setCountryName(countryName);

		MongoConnector.cleanCollection(getClass().getSimpleName());
	}

	@Test
	public void us70014KoboCampaignRegistrationByDykscTest() {
