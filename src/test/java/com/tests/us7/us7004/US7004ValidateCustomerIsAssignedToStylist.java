...
public class US7004ValidateCustomerIsAssignedToStylist extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		if (size > 0) {
			...
			stylistPassword = MongoReader.grabCustomerFormModels("US7004RegularCustDykscSearchByNameTest").get(0).getPassword();
	...
	@Test
	public void us7004ValidateCustomerIsAssignedToStylist() {
