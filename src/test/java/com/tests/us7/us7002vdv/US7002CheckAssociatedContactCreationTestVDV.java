...
public class US7002CheckAssociatedContactCreationTestVDV extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		customerFormModel = MongoReader.grabCustomerFormModels("US7002RegularCustRegistrationOnContextTestVDV").get(0);
		addressModel = MongoReader.grabAddressModels("US7002RegularCustRegistrationOnContextTestVDV").get(0);
	...
	@Test
	public void us7002CheckAssociatedContactCreationTestVDV() {
