...
public class US7003ValidateCustomerIsAssignedToStylistVDV extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		if (size > 0) {
			...
			stylistPassword = MongoReader.grabCustomerFormModels("US7003RegularCustDykscSearchByPlzTestVDV").get(0).getPassword();
	...
	@Test
	public void us7003ValidateCustomerIsAssignedToStylistVDV() {
