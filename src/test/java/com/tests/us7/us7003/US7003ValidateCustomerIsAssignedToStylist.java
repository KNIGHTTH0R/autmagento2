...
public class US7003ValidateCustomerIsAssignedToStylist extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		if (size > 0) {
			...
			stylistPassword = MongoReader.grabCustomerFormModels("US7003RegularCustDykscSearchyPlzTest").get(0).getPassword();
	...
	@Test
	public void us7003ValidateCustomerIsAssignedToStylist() {
