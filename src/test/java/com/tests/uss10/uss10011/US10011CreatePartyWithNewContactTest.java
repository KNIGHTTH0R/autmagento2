...
public class US10011CreatePartyWithNewContactTest extends BaseTest {
	...
	@Test
	public void us10011CreatePartyWithNewContactTest() {
		customerRegistrationSteps.performLogin(username, password);
	
		headerSteps.goToCreatePartyWithNewContactPage();
		createNewContactSteps.fillCreateNewContactWithoutAnyInterrestAndWithoutEmail(customerData, addressData);
