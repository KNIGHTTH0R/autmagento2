...
public class US10001aCreatePartyWithCustomerHostESTest extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		try {
			...
			customerName = prop.getProperty("customerNameAT");
	...
	@Test
	public void us10001aCreatePartyWithCustomerHostESTest() {
		...
		urlModel.setUrl(partyCreationSteps.fillPartyDetailsForCustomerHostAT(customerName));
