...
public class US14001ValidateCustomerIsAssignedToStylist extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		if (size > 0) {
			...
			stylistPassword = MongoReader.grabCustomerFormModels("US14001StyleCoachLeadDistributionTest").get(0).getPassword();
		} else
			System.out.println("The database has no entries");

		stylistsList = MongoReader.grabDbStylistModels("US14001ChangeCustomerAddressTest");
		
		MongoConnector.cleanCollection(getClass().getSimpleName());
	}

	@Test
	public void us14001ValidateCustomerIsAssignedToStylist() {
