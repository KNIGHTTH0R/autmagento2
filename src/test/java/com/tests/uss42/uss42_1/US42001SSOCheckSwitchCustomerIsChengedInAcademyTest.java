...
public class US42001SSOCheckSwitchCustomerIsChengedInAcademyTest extends BaseTest {
	...
	@Test
	public void us42001SSOCheckSwitchCustomerIsChengedInAcademyTest() throws SQLException {
		...
		loginAcademySteps.performAcademyLogin("sso_stylist@evozon.com", password);
		...
		singleSignOnSteps.validateShopLoginOtherWebsiteAndStoreView(WebsiteAndStoreViewConstants.DE_WEBSITE,
				WebsiteAndStoreViewConstants.DE_STORE_VIEW,"JULIA");
