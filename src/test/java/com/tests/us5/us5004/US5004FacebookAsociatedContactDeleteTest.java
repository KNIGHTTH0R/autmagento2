...
public class US5004FacebookAsociatedContactDeleteTest extends BaseTest{
	...
	public void setUp() throws Exception {
		...
		try {
			...
			input = new FileInputStream(UrlConstants.RESOURCES_PATH + FilePaths.US_05_FOLDER + File.separator + "us5004.properties");
			prop.load(input);
	...
	@Test
	public void us5004FacebookAsociatedContactDeleteTest() throws SOAPException, IOException{
