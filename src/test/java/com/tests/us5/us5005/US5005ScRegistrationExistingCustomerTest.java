...
public class US5005ScRegistrationExistingCustomerTest extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		int size = MongoReader.grabCustomerFormModels("US5004FacebookRegUserFBLoggedOutAppNotInstaledTest").size();
		if (size > 0) {
			stylistData = MongoReader.grabCustomerFormModels("US5004FacebookRegUserFBLoggedOutAppNotInstaledTest").get(0);
		} else
	...
	@Test
	public void us5005ScRegistrationExistingCustomerTest() {
