...
public class US5001FacebookRegUserLoggedInFBAppNotInstaledTest extends BaseTest{
	...
	private String fbEmail, fbPass, appID, fbName;
	@Steps
	...
	@Test
	public void us5001FacebookRegUserLoggedInFBAppNotInstaledTest() throws Exception {
