...
@WithTag(name = "US8003", type = "external")
@Story(Application.Shop.RegularCart.class)
@RunWith(ThucydidesRunner.class)
public class US8003ValidateOrderEmailTest extends BaseTest{
	...
	public void setUp() throws Exception {
		...
		orderModel = MongoReader.getOrderModel("US8003CustomerBuyWithForthyDiscountsJbAndBuy3Get1Test" + Constants.GRAB);
	...
	@Test
	public void us8003ValidateOrderEmailTest() {
