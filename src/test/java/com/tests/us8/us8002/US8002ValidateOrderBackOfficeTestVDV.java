...
public class US8002ValidateOrderBackOfficeTestVDV extends BaseTest {
	...
	public void setUp() {
		...
		List<OrderModel> orderModelList = MongoReader.getOrderModel("US8002CustomerBuyWithLbAndThirtyDiscountTestVDV" + SoapKeys.GRAB);
		productsList = MongoReader.grabRegularBasicProductModel("US8002CustomerBuyWithLbAndThirtyDiscountTestVDV" + SoapKeys.CALC);
		shippingModelList = MongoReader.grabShippingModel("US8002CustomerBuyWithLbAndThirtyDiscountTestVDV" + SoapKeys.CALC);
		calcDetailsModelList = MongoReader.grabRegularCartCalcDetailsModels("US8002CustomerBuyWithLbAndThirtyDiscountTestVDV" + SoapKeys.CALC);
		
		System.out.println(productsList.size());
		System.out.println(shippingModelList.size());
		System.out.println(calcDetailsModelList.size());
		...
		System.out.println("IIIIP: "+shopTotalsModel.getTotalIP());
	 ...
	 */
	@Test
	public void us8002ValidateOrderBackOfficeTestVDV() {
