...
public class US8004CheckOrderOnCustomerProfileTest extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		orderModel = MongoReader.grabOrderModels("US8004CustomerBuyWithContactBoosterTest" + SoapKeys.GRAB).get(0);

	}

	@Test
	public void us8004CheckOrderOnCustomerProfileTest() {
