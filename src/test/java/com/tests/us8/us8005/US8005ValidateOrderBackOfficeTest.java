...
@WithTag(name = "US8.5 Customer Buy With Free Shipping Voucher Test", type = "Scenarios")
@Story(Application.RegularCart.US8_5.class)
@RunWith(SerenityRunner.class)
public class US8005ValidateOrderBackOfficeTest extends BaseTest {
	...
	public void setUp() {
		...
		try {
			...
			input = new FileInputStream(UrlConstants.RESOURCES_PATH + "us8" + File.separator + "us8005.properties");
			prop.load(input);
		...
		List<OrderModel> orderModelList = MongoReader.getOrderModel("US8005CustomerBuyWithShippingVoucherTest" + SoapKeys.GRAB);
		productsList = MongoReader.grabRegularBasicProductModel("US8005CustomerBuyWithShippingVoucherTest" + SoapKeys.CALC);
		shippingModelList = MongoReader.grabShippingModel("US8005CustomerBuyWithShippingVoucherTest" + SoapKeys.CALC);
		calcDetailsModelList = MongoReader.grabRegularCartCalcDetailsModels("US8005CustomerBuyWithShippingVoucherTest" + SoapKeys.CALC);
	 ...
	 */
	@Test
	public void us8005ValidateOrderBackOfficeTest() {
