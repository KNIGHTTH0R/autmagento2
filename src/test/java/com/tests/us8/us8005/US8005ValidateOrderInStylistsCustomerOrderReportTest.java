...
public class US8005ValidateOrderInStylistsCustomerOrderReportTest extends BaseTest{
	...
	public void setUp() throws Exception {
		...
		orderModel = MongoReader.grabOrderModels("US8005CustomerBuyWithShippingVoucherTest" + SoapKeys.GRAB).get(0);
		
	}
	
	@Test
	public void us8005ValidateOrderInStylistsCustomerOrderReportTest() {
