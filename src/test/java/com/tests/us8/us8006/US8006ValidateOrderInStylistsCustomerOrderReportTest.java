...
public class US8006ValidateOrderInStylistsCustomerOrderReportTest extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		orderModel = MongoReader.grabOrderModels("US8006CustomerBuyWithVoucherPartiallyOnShippingTest" + SoapKeys.GRAB).get(0);

	}

	@Test
	public void us8006ValidateOrderInStylistsCustomerOrderReportTest() {
