...
public class US30018SfmWithTPFreeShippingTest extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		try {
			...
			input = new FileInputStream(
					UrlConstants.RESOURCES_PATH + FilePaths.US_03_FOLDER + File.separator + "us30010.properties");
			prop.load(input);
	...
	public void us30018SfmWithTPFreeShippingTest() throws ParseException {
		...
		CartCalculator.shippingCalculatedModeTP0=CartCalculator.calculateShippingTotalsTP(CartCalculator.calculatedTotalsDiscountsTp0, "0");
		CartCalculator.shippingCalculatedModeTP1=CartCalculator.calculateShippingTotalsTP(CartCalculator.calculatedTotalsDiscountsTp1, "0");
		CartCalculator.shippingCalculatedModeTP2=CartCalculator.calculateShippingTotalsTP(CartCalculator.calculatedTotalsDiscountsTp2, "0");
