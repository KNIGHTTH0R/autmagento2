...
public class US3002UserProfileOrderIdTest extends BaseTest{
	...
	public void setUp() throws Exception {
		...
		try {
			input = new FileInputStream(Constants.RESOURCES_PATH + FilePaths.US_03_FOLDER + File.separator + "us3002.properties");
			prop.load(input);
		...
		orderModel = MongoReader.grabOrderModels("US3002Test" + SoapKeys.GRAB).get(0);
