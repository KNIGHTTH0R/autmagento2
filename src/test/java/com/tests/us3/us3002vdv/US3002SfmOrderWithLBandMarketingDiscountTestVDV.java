package com.tests.us3.us3002vdv;
...
public class US3002SfmOrderWithLBandMarketingDiscountTestVDV extends BaseTest {
	...
	@Test
	public void us3002SfmOrderWithLBandMarketingDiscountTestVDV() {
		...
		productData = addProductsWorkflow.setMarketingProductToCart(genProduct2, "1", "0", ConfigConstants.DISCOUNT_0);
		CartCalculator.productsListMarketing.add(productData);		
		
		System.out.println("marketing"+CartCalculator.productsListMarketing.get(0));
		
		CartCalculator.calculateLMDiscounts(jewelryDisount, marketingDisount, taxClass, shippingValue);
		...
		validationWorkflows.performCartWithMarketingValidations();
