...
public class US30021SfmWithTPImmediateAndTPProducts extends BaseTest {
...
//	private ProductDetailedModel genProduct3;
	...
	public void setUp() throws Exception {
		...
		productsList = MongoReader.grabBasicProductModel("US30021BuyProductsWithTPForTheFirstTimeTest" + SoapKeys.GRAB);
		
		genProduct1 = MagentoProductCalls.createNotAvailableYetProductModel();
		genProduct1.setPrice("49.00");
		genProduct1.setIp("20");
	...
	@Test
	public void us30021SfmWithTPImmediateAndTPProducts() throws ParseException {
		...
		String deliveryTP2 = DateUtils.getFirstFridayAfterDate(
				DateUtils.addDaysToAAGivenDate(genProduct2.getStockData().getEarliestAvailability(), "yyyy-MM-dd", 7),
				"yyyy-MM-dd");
...
;
		...
		regularUserCartSteps.clickDeliverAtSeparateDate();
