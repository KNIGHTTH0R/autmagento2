...
public class US3008CheckOrderOnStylecoachProfileTest extends BaseTest{
	...
	public void setUp() throws Exception {
		...
		orderModel = MongoReader.grabOrderModels("US3008SfmNoVatNoSmbBillingDeShippingAtTest" + SoapKeys.GRAB).get(0);
		
	}
	
	@Test
	public void us3008CheckOrderOnStylecoachProfileTest() {
