...
public class US3001ValidateOrderBackOfficeTest extends BaseTest {
	...
	public void setUp() {
		...
		List<OrderModel> orderModelList = MongoReader.getOrderModel("US3001SfmOrderWithNoDiscountTest" + SoapKeys.GRAB);
		productsList = MongoReader.grabBasicProductModel("US3001SfmOrderWithNoDiscountTest" + SoapKeys.GRAB);
		shippingModelList = MongoReader.grabShippingModel("US3001SfmOrderWithNoDiscountTest" + SoapKeys.CALC);
		calcDetailsModelList = MongoReader.grabCalcDetailsModels("US3001SfmOrderWithNoDiscountTest" + SoapKeys.CALC);
