...
public class US30014SfmWithTPNoVatNoSmbBillingShippingAtTest extends BaseTest {
	...
	public void us30014SfmWithTPNoVatNoSmbBillingShippingAtTest() throws ParseException {
		...
		cartSteps.selectDeliveryDate(genProduct2.getSku(), deliveryTP1Locale, "50-table");
		cartSteps.selectDeliveryDate(genProduct3.getSku(), deliveryTP2Locale, "table-marketing-material");
