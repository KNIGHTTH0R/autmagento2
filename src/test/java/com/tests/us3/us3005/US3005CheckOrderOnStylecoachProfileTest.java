...
public class US3005CheckOrderOnStylecoachProfileTest extends BaseTest{
	...
	public void setUp() throws Exception {
		...
		orderModel = MongoReader.grabOrderModels("US3005SfmValidVatSmbBillingDeShippingAtTest" + SoapKeys.GRAB).get(0);
		
	}
	
	@Test
	public void us3005CheckOrderOnStylecoachProfileTest() {
