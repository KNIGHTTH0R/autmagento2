...
public class US3001ValidateReorderBackOfficeTest extends BaseTest {
	...
	public void setUp() {
		...
		List<OrderModel> orderModelList = MongoReader.getOrderModel("US3001ReorderSfmValidVatNoSmbBillingShippingNotDeTest" + SoapKeys.GRAB);
		productsList = MongoReader.grabBasicProductModel("US3001ReorderSfmValidVatNoSmbBillingShippingNotDeTest" + SoapKeys.GRAB);
		shippingModelList = MongoReader.grabShippingModel("US3001ReorderSfmValidVatNoSmbBillingShippingNotDeTest" + SoapKeys.CALC);
		calcDetailsModelList = MongoReader.grabCalcDetailsModels("US3001ReorderSfmValidVatNoSmbBillingShippingNotDeTest" + SoapKeys.CALC);
