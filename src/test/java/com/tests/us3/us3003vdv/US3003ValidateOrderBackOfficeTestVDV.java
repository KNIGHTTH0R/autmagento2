...
public class US3003ValidateOrderBackOfficeTestVDV extends BaseTest {
	...
	public void setUp() {
		...
		List<OrderModel> orderModelList = MongoReader
				.getOrderModel("US3003SfmWithLbAppliedTestVDV" + SoapKeys.GRAB);
		productsList = MongoReader.grabBasicProductModel("US3003SfmWithLbAppliedTestVDV" + SoapKeys.GRAB);
		shippingModelList = MongoReader
				.grabShippingModel("US3003SfmWithLbAppliedTestVDV" + SoapKeys.CALC);
		calcDetailsModelList = MongoReader
				.grabCalcDetailsModels("US3003SfmWithLbAppliedTestVDV" + SoapKeys.CALC);
	 ...
	 */
	@Test
	public void us3003ValidateOrderBackOfficeTestVDV() {
