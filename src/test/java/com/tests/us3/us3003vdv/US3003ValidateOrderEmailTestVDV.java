...
public class US3003ValidateOrderEmailTestVDV extends BaseTest{
	...
	public void setUp() throws Exception {
		...
		List<OrderModel> orderModelList = MongoReader.getOrderModel("US3003SfmWithLbAppliedTestVDV" + SoapKeys.GRAB);
		productsList = MongoReader.grabBasicProductModel("US3003SfmWithLbAppliedTestVDV" + SoapKeys.RECALC);
		shippingModelList = MongoReader.grabShippingModel("US3003SfmWithLbAppliedTestVDV" + SoapKeys.CALC);
		calcDetailsModelList = MongoReader.grabCalcDetailsModels("US3003SfmWithLbAppliedTestVDV" + SoapKeys.CALC);
