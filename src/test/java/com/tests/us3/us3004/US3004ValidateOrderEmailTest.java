...
public class US3004ValidateOrderEmailTest extends BaseTest{
	...
	public void setUp() throws Exception {
		...
		orderModel = MongoReader.getOrderModel("US3004SfmValidVatSmbBillingShippingAtTest" + SoapKeys.GRAB);
	...
	public void us3004ValidateOrderEmailTest() {
		...
		String message = gmailConnector.searchForMail(email, orderModel.get(0).getOrderId(), true);
