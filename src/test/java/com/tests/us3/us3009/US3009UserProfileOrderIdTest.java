...
public class US3009UserProfileOrderIdTest extends BaseTest{
	...
	public void setUp() throws Exception {
		...
		try {
			input = new FileInputStream(Constants.RESOURCES_PATH + FilePaths.US_03_FOLDER + File.separator + "us3009.properties");
			prop.load(input);
		...
		orderModel = MongoReader.grabOrderModels("US3009Test" + SoapKeys.GRAB).get(0);
		
	}
	
	@Test
	public void us3009UserProfileOrderIdTest() {
