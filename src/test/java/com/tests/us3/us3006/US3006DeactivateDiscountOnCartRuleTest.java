...
public class US3006DeactivateDiscountOnCartRuleTest extends BaseTest {

	@Steps
	public ShoppingCartPriceRulesSteps shoppingCartPriceRulesSteps;

	@Test
	public void us3006DeactivateDiscountOnCartRuleTest() {
		shoppingCartPriceRulesSteps.deactivateRule("AUT-Money voucher working on shipping fee - all carts");
	}
}
