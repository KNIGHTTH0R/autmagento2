...
public class US3006ValidateOrderBackOfficeTest extends BaseTest {
	...
	public void setUp() {
		...
		try {
			...
			input = new FileInputStream(Constants.RESOURCES_PATH + Constants.US_03_FOLDER + File.separator + "us3006.properties");
			prop.load(input);
		...
		List<OrderModel> orderModelList = MongoReader.getOrderModel("US3006Test" + Constants.GRAB);
		productsList = MongoReader.grabBasicProductModel("US3006Test" + Constants.GRAB);
		shippingModelList = MongoReader.grabShippingModel("US3006Test" + Constants.CALC);
		calcDetailsModelList = MongoReader.grabCalcDetailsModels("US3006Test" + Constants.CALC);
