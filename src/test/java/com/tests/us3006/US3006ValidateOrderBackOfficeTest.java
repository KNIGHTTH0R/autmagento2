...
@WithTag(name = "US3006", type = "backend")
@Story(Application.StyleCoach.Shopping.class)
@RunWith(ThucydidesRunner.class)
public class US3006ValidateOrderBackOfficeTest extends BaseTest {
	...
	public void setUp() {
		...
		List<OrderModel> orderModelList = MongoReader.getOrderModel("US3006CartSegmentationWithVatAndSmbBillingShippingDeTest" + Constants.GRAB);
		productsList = MongoReader.grabProductBasicModel("US3006CartSegmentationWithVatAndSmbBillingShippingDeTest" + Constants.GRAB);
		shippingModelList = MongoReader.grabShippingModel("US3006CartSegmentationWithVatAndSmbBillingShippingDeTest" + Constants.CALC);
		calcDetailsModelList = MongoReader.grabCalcDetailsModels("US3006CartSegmentationWithVatAndSmbBillingShippingDeTest" + Constants.CALC);
