...
public class US22001VerifySCPerformanceNewIpLogicBackendTestVDV extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		ipModel = commissionReportSteps.closeLastMonthAndGetCurrentMonthIps(stylistId,ipCorrection);
		...
		System.out.println(expectedLoungeIpPerformanceModel);
	}
	...
	public void us22001VerifySCPerformanceNewIpLogicBackendTestVDV() {
		...
		System.out.println(grabbedLoungeIpPerformanceModel);
