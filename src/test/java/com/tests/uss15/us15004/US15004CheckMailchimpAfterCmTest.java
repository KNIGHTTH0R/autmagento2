...
public class US15004CheckMailchimpAfterCmTest extends BaseTest {
	...
	public void us15004CheckMailchimpAfterCmTest() {
		...
		expectedSubscriberModel = mailchimpValidationWorkflows.populatePlaceCustomerOrderSubscriberWithZeroRevenues(dataModel, dateModel, product, shippingModel, koboCode);
