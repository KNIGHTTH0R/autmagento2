...
public class US15004ConfirmCustomerTest extends BaseTest {
	...
	public void setUp() throws Exception {
		...
		stylistEmail = MongoReader.grabCustomerFormModels("US15004OrderZzzProductsForCustomerTest").get(0)
				.getEmailName();
	...
	public void us15004ConfirmCustomerTest() throws Exception {
		...
		dateModel.setDate(emailClientSteps.confirmAccount(stylistEmail.replace("@" + ConfigConstants.WEB_MAIL, ""),
